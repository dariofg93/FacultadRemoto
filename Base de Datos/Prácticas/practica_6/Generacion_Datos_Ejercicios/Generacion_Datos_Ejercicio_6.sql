...
CREATE TABLE PRECIO (
  ...
  fechaRegistro DATE,
  precio DECIMAL(10,2),
  PRIMARY KEY(pid, comercio, fechaRegistro),
...
VALUES 
("Enlatado","Decripciòn de Enlatado"),
("Bolsa","Descripciòn de Bolsa"),
("Sachet","Descripciòn de Sachet"),
("Frasco","Descripciòn de Frasco"),
("Paquete","Descripciòn de Paquete"),
("Caja","Descripciòn de Caja"),
("Sobre","Descripciòn de Sobre"),
("Botella","Descripciòn de Botella"),
("Envase Retornable","Descripciòn de Envase Retornable"),
("Bandeja","Descripciòn de Bandeja");
